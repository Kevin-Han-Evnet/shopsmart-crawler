...
class ProductAndEvent :


    #으으음 ㅋㅋㅋ
    #신상품 크롤링
    def getNewProductList (self, pNum, research_idx, target_name, crawling_engine, np_url, tag_selector, sub_tag_selector, img_tag_selector, np_code_name, not_nessesary_strings) :
        ...
        if (itemcount > 0) : self.getNewProductList (self, pNum + 1, research_idx, target_name, crawling_engine, np_url, tag_selector, sub_tag_selector, img_tag_selector, np_code_name, not_nessesary_strings)


    #이벤트 크롤링 -- 메롱
    def getEventList (self, pNum, research_idx, target_name, crawling_engine, event_url, tag_selector, sub_tag_selector, img_tag_selector, event_code_name, not_nessesary_strings) :
        ...
        if (int (itemcount) > 0) : self.getEventList (self, pNum + 1, research_idx, target_name, crawling_engine, event_url, tag_selector, sub_tag_selector, img_tag_selector, event_code_name, not_nessesary_strings)
    ...
    def doIt (self):
        ...
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"====================================================================================")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"신상품 및 이벤트 정보 수집을 시작합니다.=========================================")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"\n\n\n")
        ...
        if (len (research_list) > 0) :
            for research in research_list :
                ...
                if (int(research['np_crawling_stat']) == 1) :
                    ...
                    self.getNewProductList (self, 1, research['idx'], research['target_name'], research['crawling_engine'], research['np_list_page'], research['np_tag_selector'],
                ...
                if (int(research['event_crawling_stat']) == 1) :
                    ...
                    self.getEventList (self, 1, research['idx'], research['target_name'], research['crawling_engine'], research['event_list_page'], research['event_tag_selector'], research['event_sub_tag_selector'], research['event_img_tag_selector'],
        ...
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"\n\n\n")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"====================================================================================")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"신상품 및 이벤트 정보 수집을 완료했습니다.=======================================")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"\n\n\n")



#ProductAndEvent.doIt(ProductAndEvent)