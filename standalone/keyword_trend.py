...
class KeywordTrend :
    ...
    #키워드 트렌드 크롤링
    def getQueryCount (self, research_idx, target_name,
    ...
    def doIt (self) :
        ...
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"==========================================================================")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"키워드 트렌드 정보 수집을 시작합니다.================================================")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"\n\n\n")
        ...
        if (len (research_list) > 0) :
            for research in research_list :
                ...
                if (int(research['keyword_trend_crawling_stat']) == 1) :
                    ...
                    self.getQueryCount (self, research['idx'], membership['comp_nm'],
        ...
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"\n\n\n")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"====================================================================================")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"키워드 트렌드 정보 수집을 완료 했습니다.================================================")
        SmLogger.info (SmLogger, os.path.basename(__file__) + " " +"\n\n\n")